...
def run():
    ...
    print(f"  Total Return       : {metrics.get('total_return', 0):>12.1%}")
    print(f"  CAGR               : {metrics.get('cagr', 0):>12.1%}")
    print(f"  Max Drawdown       : {metrics.get('max_drawdown', 0):>12.1%}")
    print(f"  Sharpe Ratio       : {metrics.get('sharpe', 0):>12.3f}")
    print(f"  Total Trades       : {metrics.get('n_trades', 0):>12}")
    print(f"  Win Rate           : {metrics.get('win_rate', 0):>12.1%}")
